...
- 🌀 **Visual delight meets productivity**: Tilted sticky notes, hover animations, and pin-style effects turn organization into a calming ritual and not a chore.
...
<img width="1185" height="713" alt="Screenshot 2025-08-03 at 6 34 55 PM" src="https://github.com/user-attachments/assets/f1fae0ef-59e0-407c-82ea-207e8c1ee5b6" />


#### 🧠 MindMap Tab — Turn Thoughts Into Clear, Visual Structure

The **MindMap Tab** helps you map out ideas, goals, or problems into a clean, tree-style visualization that makes sense at a glance.
...
- ✍️ **Every node includes context** — not just a word, but a helpful explanation so you understand each part
  
- 🔁 **Offline + AI-powered**: The structure is generated locally using your input and enhanced with Gemma’s semantic understanding

  <img width="1177" height="716" alt="Screenshot 2025-07-28 at 7 10 23 PM" src="https://github.com/user-attachments/assets/ca486d6a-8796-40a2-8a95-bc3fd89ad699" />
...
- ✏️ **Write freely in a guided chat flow**: Prompts appear like a conversation. Respond at your pace. Gemma listens.
...
> 🔄 **Gemma’s Role**:  
Gemma acts like an empathetic listener and cognitive mirror, reading between the lines, highlighting your strength, and helping you connect meaning to your experiences. Her responses are grounded in *your story*.

> 💡 **The Problem It Solves**:  
Many people struggle to process emotions or build a consistent reflection habit. The SupportMe Tab makes it easier by **giving structure to your healing**, **a voice to your thoughts**, and **warmth to your solitude**, all without requiring therapy sessions or internet access.

<img width="1090" height="682" alt="Screenshot 2025-07-28 at 7 12 04 PM" src="https://github.com/user-attachments/assets/e8aeb45b-ba55-46bc-9a50-9494a8c39e7e" />


<img width="1172" height="715" alt="Screenshot 2025-08-01 at 1 51 37 PM" src="https://github.com/user-attachments/assets/c97975c2-114f-4547-974d-42cd20725e4a" />
